...
class KeywordSearchService:
    ...
    def _calculate_score(
        ...
        for field_name, field_value in fields.items():
            ...
            field_text = field_value.lower() if isinstance(field_value, str) else " ".join(str(v).lower() for v in field_value)
    ...
    def _search_graph(self, tokens: List[str], include_docs: bool) -> List[SearchResult]:
        """搜索 KnowledgeGraph"""
        results = []
