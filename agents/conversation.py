...
规则：
1. 基于提供的知识库内容回答，合理推断和综合信息
2. 即使信息分散在多个片段中，也要尝试整合回答，不要简单说"未提及"
3. 如果确实完全没有相关信息，诚实说明
4. 回答中用 [来源: 笔记/文献名] 标注引用来源
5. 用中文回答（除非用户用英文提问）
6. 简洁、专业、有条理

重要：用户的问题是关于已检索到的文献内容，请基于检索到的上下文片段给出最佳回答。如果上下文中有相关信息，即使不完整，也请基于现有信息回答，并说明信息来源。"""
